<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="cProductos.aspx.cs" Inherits="ProyectoFinal_Aplicada2.UI.Consultas.cProductos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-primary">
            ...
            <div class="form-group ">
                ...
                <div class="col-md-2">
                    <asp:DropDownList ID="FiltroDropDown" runat="server" CssClass="form-control input-sm">
                        ...
                        <asp:ListItem>ProveedorId</asp:ListItem>
        ...
        <asp:GridView ID="Grid" runat="server" class="table table-condensed table-responsive" AutoGenerateColumns="true" ShowHeaderWhenEmpty="True" DataKeyNames="ProductoId" CellPadding="4" ForeColor="Black" GridLines="None">
            <EmptyDataTemplate>
