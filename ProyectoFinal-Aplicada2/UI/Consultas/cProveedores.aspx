<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="cProveedores.aspx.cs" Inherits="ProyectoFinal_Aplicada2.UI.Consultas.cProveedores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">Consulta de Provedores</div>
        ...
        <asp:GridView ID="Grid" runat="server" class="table table-condensed table-responsive" AutoGenerateColumns="true" ShowHeaderWhenEmpty="True" DataKeyNames="ProveedorId" CellPadding="4" ForeColor="Black" GridLines="None">
            <EmptyDataTemplate>
