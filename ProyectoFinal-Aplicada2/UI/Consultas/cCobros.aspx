<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="cCobros.aspx.cs" Inherits="ProyectoFinal_Aplicada2.UI.Consultas.cCobros" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">Consulta de Cobros</div>
        ...
        <asp:GridView ID="Grid" runat="server" class="table table-condensed table-responsive" AutoGenerateColumns="true" ShowHeaderWhenEmpty="True" DataKeyNames="CobroId" CellPadding="4" ForeColor="Black" GridLines="None">
            <EmptyDataTemplate>
