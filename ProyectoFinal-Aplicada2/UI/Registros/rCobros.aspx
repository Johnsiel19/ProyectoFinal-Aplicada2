        ...
        <div class="form-horizontal col-md-12" role="form">
           ...
           <div class="form-group">
                      <label for="Ventalabel" class="col-md-3 control-label input-sm" style="font-size: small" >VentaId</label>
                         <div class="col-md-4">
                            <asp:DropDownList   runat="server" AutoPostBack="true" ID="VentaIdTextbox" class="form-control input-sm" Style="font-size: small" ></asp:DropDownList>
                        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <asp:TextBox ID="ClienteTextBox" runat="server"  onkeypress="return isLetterKey(event)" class="form-control input-sm" Style="font-size: small"></asp:TextBox>
                </div>
