<%@ Page Title="" Language="C#" MasterPageFile="~/Master2.Master" AutoEventWireup="true" CodeBehind="rLogIn.aspx.cs" Inherits="ProyectoFinal_Aplicada2.rLogIn" %>
                ...
                <div class="form-horizontal col-md-12" role="form">
                    ...
                    <div class="container">
                        <div class="form-group">
                            ...
                            <div class="col-md-1 ">
                                <asp:TextBox ID="UsuarioIdTextBox" ReadOnly="true" runat="server" placeholder="0" class="form-control input-sm" Style="font-size: small" TextMode="Number"></asp:TextBox>
                            </div>
